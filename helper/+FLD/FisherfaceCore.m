function [m_database V_PCA V_Fisher ProjectedImages_Fisher, ProjectedImages_PCA] = FisherfaceCore(T, Class_number, Class_population )
...
A = double(T) - repmat(m_database,1,P);
...
num_features = Class_number-1; 
V_Fisher = J_eig_vec(:, 1:num_features); 
